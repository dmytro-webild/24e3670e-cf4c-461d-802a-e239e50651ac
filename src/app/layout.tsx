...
export const metadata: Metadata = {
  title: "Creative Web Agency | Award-Winning Design & Development",  description: "Transform your vision into digital reality. Award-winning creative agency specializing in web design, brand strategy, and digital marketing for forward-thinking companies.",  keywords: "web agency, web design, brand design, digital marketing, UX/UI design, web development, creative studio, digital solutions",  metadataBase: new URL("https://www.creativestudio.com"),
  alternates: {
    canonical: "https://www.creativestudio.com"},
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Creative Web Agency | Transform Your Vision Into Digital Reality",    description: "Award-winning creative agency specializing in web design, brand strategy, and digital marketing.",    url: "https://www.creativestudio.com",    siteName: "Creative Studio",    type: "website",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AWS0SvlKRcaADFivgsxikxljMH/a-stunning-creative-agency-dashboard-sho-1772823183019-5d98d3ac.png",        alt: "Creative Studio - Web Design & Development"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Creative Web Agency | Award-Winning Design & Development",    description: "Transform your vision into digital reality. Award-winning creative agency specializing in web design, brand strategy, and digital marketing.",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AWS0SvlKRcaADFivgsxikxljMH/a-stunning-creative-agency-dashboard-sho-1772823183019-5d98d3ac.png"],
  },
};
